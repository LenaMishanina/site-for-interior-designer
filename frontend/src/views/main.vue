  ...
  <div class="main_frame">
    ...
    <div class="navigation_menu_top">
      <div class="navigation_menu_top_main">
        <div class="logo_top" @click="forward('.main_frame', 150)">
          MILKOVA<br />PROJECT.RU
        </div>
        ...
        <div class="list_with_button_to_blocks_top">
          <button
            @click="forward('.calculate_prices', 150)"
            class="button_to_prices_top"
          >
            ЦЕНЫ
          </button>
          <button
            @click="forward('.about_me', 140)"
            class="button_to_about_me_top"
          >
            ОБО МНЕ
          </button>
          <button
            @click="forward('.service', 80)"
            class="button_to_services_top"
          >
            УСЛУГИ
          </button>
          <button @click="forward('.stages', 80)" class="button_to_stages_top">
            ЭТАПЫ
          </button>
          <button
            @click="forward('.portfolio', 80)"
            class="button_to_portfolio_top"
          >
            ПОРТФОЛИО
          </button>
          <button
            @click="forward('.request', 30)"
            class="button_to_request_top"
          >
            ЗАЯВКА
          </button>
          <button
            @click="forward('.contacts', 0)"
            class="button_to_contacts_top"
          >
            КОНТАКТЫ
          </button>
        </div>
    ...
    <div :class="['nav_menu_for_mobile', { show: isMenuVisible }]">
      <div class="nav_menu_for_mobile_container">
        <div class="logo_and_img_container">
          <div
            class="logo"
            @click="forward('.small_section_about_me_mobile', 200)"
          >
            MILKOVA<br />PROJECT.RU
          </div>
          <div class="container_for_double_arrow">
            <img
              @click="toggleMenu"
              class="double_arrow"
              src="../assets/images/double_arrow.png"
            />
          </div>
        </div>
        ...
        <div class="contacts_mobile">
          <a href="https://instagram.com/alina_milkova_project"
            ><img
              class="icon_instagram"
              src="../assets/images/inst_icon.png"
              alt=""
          /></a>
          <a href="tel:+79159849794"
            ><img
              class="icon_telephone"
              src="../assets/images/telephone_icon.png"
              alt=""
          /></a>
          <a href="mailto:kalina-@mail.ru"
            ><img class="icon_mail" src="../assets/images/mail_icon.png" alt=""
          /></a>
        </div>
      </div>
    </div>
    ...
    <div class="small_section_about_me">
      <div class="small_section_about_me_main">
        <div class="first_photo_container">
          <img
            class="first_photo"
            src="../assets/images/interior_photo.png"
            alt=""
          />
        </div>
        <div class="main_theme">
          ...
          <button
            @click="forward('.request', 30)"
            class="button_for_get_consultation"
          >
    ...
    <div class="small_section_about_me_mobile">
      ...
      <button
        @click="forward('.request', 100)"
        class="button_for_get_consultation_mobile"
      >
        Получить консультацию
      </button>
    </div>
      ...
      <div class="counting_block">
        <div class="slider_block">
          ...
          <input
            ...
            max="300"
            value="80"
            oninput="document.querySelector('.rangeValue').innerText = this.value"
          />
        </div>
        ...
        <div class="output1">
          ...
          <div class="total_price">
            <p class="price_container">
              От <span class="result-block1">96000</span> рублей
            </p>
            <button
              @click="forward('.service', 80)"
              class="button_for_get_more"
            >
              Подробнее
            </button>
          </div>
        ...
        <div class="output1">
          ...
          <div class="total_price">
            <p class="price_container">
              От <span class="result-block2">24000</span> рублей
            </p>
            <button
              @click="forward('.service', 80)"
              class="button_for_get_more"
    ...
    <div class="calculate_prices_mobile">
      <p class="title_price">РАСЧЕТ ЦЕНЫ</p>
      ...
      <div class="counting_block">
        <div class="slider_block">
          ...
          <input
            ...
            max="300"
            value="80"
            oninput="document.querySelector('.rangeValue1').innerText = this.value"
          />
        </div>
        ...
        <div class="output1">
          ...
          <div class="total_price">
            <p class="price_container">
              От <span class="result-block3">96000</span> рублей
            </p>
            <button
              @click="forward('.service_mobile', 50)"
              class="button_for_get_more"
            >
              Подробнее
            </button>
        ...
        <div class="output1">
          ...
          <div class="total_price">
            <p class="price_container">
              От <span class="result-block4">24000</span> рублей
            </p>
            <button
              @click="forward('.service_mobile', 50)"
              class="button_for_get_more"
    ...
    <div class="about_me">
      ...
      <div class="about_me_text">
        Меня зовут Алина Милкова<br />Я дизайнер интерьера с высшим строительным
        образованием
        <div class="light_about_me_text">
          Я поэтапно расскажу вам о том, как всё будет происходить<br />от идеи
          до реализации.<br />
          Первая консультация бесплатная и не займет много времени.
        </div>
        <button @click="forward('.request', 30)" class="button_for_get_request">
          Получить консультацию
        </button>
      </div>
    </div>
    <div class="about_me_mobile">
      <div class="group_mobile">
        <div class="about_me_text_mobile">
          Меня зовут Алина Милкова<br />Я дизайнер интерьера с высшим
          строительным образованием
        </div>
        <div>
          <button
            @click="forward('.request', 100)"
            class="button_for_get_request_mobile"
          >
            Получить консультацию
          </button>
        </div>
        <div class="container_for_photo_and_text_mobile">
          <div
            class="photo_aliny_vitalevny2_mobile"
            style="position: relative; display: inline"
          >
            <img
              src="../assets/images/Component 2.png"
          ...
          <div class="light_about_me_text_mobile">
            Я поэтапно расскажу вам о том, как всё будет происходить от идеи до
            реализации.<br />Первая консультация бесплатная и не займет много
            времени.
          </div>
        </div>
      </div>
    ...
    <div class="my_advantages">
      ...
      <div class="step_advantage">
        ...
        />
        <div class="step_text">
          Я не завершу свою работу, пока вам не понравится результат
        </div>
      </div>
      <div class="step_advantage">
        <img
        ...
        />
        <div class="step_text">
          Закладываю в дизайн-проект только реальные товары, которые Вы легко
          найдете, отсканировав QR код
        </div>
      </div>
      <div class="step_advantage">
        <img
        ...
        />
        <div class="step_text">
          Создаю комфортное пространство для каждого члена семьи, учитывая его
          потребности
        </div>
      </div>
      <div class="step_advantage">
        ...
        />
        <div class="step_text">
          Даю подробное техническое задание для изготовления мебели
        </div>
      </div>
      <div class="step_advantage">
        <img
        ...
        />
        <div class="step_text">
          Отвечаю на вопросы по проекту даже после завершения сотрудничества
        </div>
      </div>
    </div>
    ...
    <div class="service" :style="backgroundStyle" id="service">
      <nav class="nav_service">
        ...
        <div class="consultion" v-for="service in servic" :key="service.id">
          ...
          <div class="one_service">
            ...
            <span
              class="description_of_service"
              v-html="service.short_description"
            ></span>
            <div class="button_wrapper">
              <span
                class="price_of_service"
                v-html="formatPrice(service)"
              ></span>
              <button
                v-if="service.name == 'Полный<br>дизайн-проект'"
                class="button"
                @click="forward('.stages', 70)"
              >
                Подробнее
              </button>
              <button v-else class="button" @click="showModal(service.name)">
                Подробнее
              </button>
              <div
                v-if="modals[service.name]"
                @click.self="closeModal(service.name)"
                class="modal-shadow"
              >
                <div class="modal">
        ...
        <div class="one_service_mobile">
          ...
          <div class="button_mobile_wrapper">
            <button
              v-if="service.name == 'Полный<br>дизайн-проект'"
              class="button_mobile"
              @click="forward('.stages_mobile', 100)"
            >
              Подробнее
            </button>
            <button
          ...
          <div
            v-if="modals[service.name]"
            @click.self="closeModal(service.name)"
            class="modal-shadow_mobile"
          >
            <div class="modal_container_mobile">
              <span
                class="modal_text_mobile"
                v-html="service.long_description"
              ></span>
            </div>
          </div>
      ...
      <div class="global_frame">
        <div class="main_frame_stages">
          ...
          <div class="technical_task hidden" id="tech_task">
            ...
            <p class="technical_task_text">
              Это первая бесплатная встреча, на которой мы с<br />
            ...
            <img
              class="technical_task_image"
              src="../assets/images/technical_task.png"
              alt=""
            />
          </div>
          ...
          <div class="visualization hidden" id="visual">
            ...
            <p class="visualization_text">
              Процесс создания трехмерной модели пространства и передачи<br />его
              внешнего вида. Позволяет наглядно представить клиенту<br />конечный
              результат проекта до его реализации.
            </p>
            <img
              class="visualization_image"
              src="../assets/images/vizualization.png"
              alt=""
            />
          </div>
          ...
          <div class="work_documentation hidden" id="work_doc">
            ...
            <p class="work_documentation_text">
              Полный комплект чертежей, необходимых для реализации проекта
              (планировочные решения, схемы электрики, светильников,
              включателей, сантехники, планы полов и потолков, развертки стен со
              всеми необходимыми данными и размерами).<br />Чтобы иметь более
              четкое представление о том, какие чертежи содержит дизайн-проект,
              я могу выслать Вам один из моих последних проектов для
              ознакомления.
            </p>
            <img
              class="work_documentation_image"
              src="../assets/images/work_document.png"
              alt=""
            />
          </div>
      ...
      <div v-for="(step, index) in steps" :key="index">
        <div class="one_step" v-if="index % 2 == 0">
          ...
          <div class="block_of_step_left_mobile">
            ...
            <div
              class="description_of_step_mobile"
    ...
    <div class="portfolio">
      <nav>
        ...
        <div class="gallery">
          <div class="photos" v-for="image in portfolio" :key="image">
          ...
          <div
            :class="['modal_photo', { show: isModalOpen }]"
            @click="togglePhoto"
          >
    ...
    <div class="request" id="request_id">
      <div class="main_request">
            ...
            <div class="for_inputs">
              ...
              <form action="" class="form" id="add_form">
                ...
                <div class="celect_config">
                  ...
                  <label class="error_label_select" v-if="!areaOpsionsVisible"
        ...
        <h2 class="more_information">
          Оставьте заявку и я свяжусь с<br />
        ...
        <div class="for_background">
          <img
            ...
            @click.self="areaOpsionsVisible = false"
            src="../assets/images/photo_laptop_b.png"
          />
        </div>
      </div>
    </div>
    ...
    <!-- БЛОК "НИЗ СТРАНИЦЫ" -->
    <div class="bottom">
      <div class="logo_bottom" @click="forward('.main_frame', 150)">
        MILKOVA<br />PROJECT.RU
      </div>
      <div class="navigation_menu_bottom">
        <button
          @click="forward('.calculate_prices', 150)"
          class="button_to_prices_bottom"
        >
          ЦЕНЫ
        </button>
        <button
          @click="forward('.about_me', 140)"
          class="button_to_about_me_bottom"
        >
          ОБО МНЕ
        </button>
        <button
          @click="forward('.service', 80)"
          class="button_to_services_bottom"
        >
          УСЛУГИ
        </button>
        <button @click="forward('.stages', 80)" class="button_to_stages_bottom">
          ЭТАПЫ
        </button>
        <button
          @click="forward('.portfolio', 80)"
          class="button_to_portfolio_bottom"
        >
          ПОРТФОЛИО
        </button>
        <button
          @click="forward('.request', 30)"
          class="button_to_request_bottom"
        >
          ЗАЯВКА
        </button>
      </div>
      <div class="contacts">
        <p class="information">
          ...
          +7-915-984-97-94<br />
          <img
            src="../assets/images/icon_inst.png"
            alt=""
            height="20"
            width="20"
          />
          @alina_milkova_project
        </p>
      </div>
    </div>
    <div class="bottom_mobile">
      <div class="container_logo_and_menu">
        <div
          class="bottom_logo_mobile"
          @click="forward('.small_section_about_me_mobile', 200)"
        >
          MILKOVA<br />PROJECT.RU
        </div>
        <div class="bottom_menu_mobile">
          <p @click="forward('.calculate_prices_mobile', 100)">ЦЕНЫ</p>
          ...
          <p @click="forward('.request', 100)">ЗАЯВКА</p>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      steps: [
        {
          ...
          description:
            "Это первая бесплатная встреча, на которой мы с вами знакомимся и обсуждаем предстоящую работу. Я рассказываю и показываю из чего состоит проект. Мы заключаем договор. Вы заполняете подробную анкету, которая будет являться техническим заданием на проектирование.",
          photo: "../assets/images/technical_task.png",
        },
        {
          name: "Проектирование пространства",
          description:
            "После подписания договора я выполняю обмер помещения. На основании технического задания создается несколько вариантов планировок, после их обсуждения и внесения правок, мы выбираем вариант, максимально учитывающий все ваши пожелания.",
          photo: "../assets/images/project_frame.png",
        },
        {
          name: "Визуализация",
          description:
            "Процесс создания трехмерной модели пространства и передачи его внешнего вида. Позволяет наглядно представить клиенту конечный результат проекта до его реализации.",
          photo: "../assets/images/vizualization.png",
        },
        {
      ...
      backgroundStyle: {
        backgroundImage: `url(${
          new URL("@/assets/images/back_service.png", import.meta.url).href
        })`,
      },
      modals: {
        consultation: false,
  ...
  methods: {
    ...
    toggleMenu() {
      // Открытие навигационного меню на телефоне
      this.isMenuVisible = !this.isMenuVisible;
    },
    togglePhoto() {
      // Открытие фото при нажатии
